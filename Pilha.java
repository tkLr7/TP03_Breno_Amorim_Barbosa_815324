...
public class Pilha {
    ...
    static List<Pilha> players = new ArrayList<>();
    ...
    Pilha (int id, String nome, int altura, int peso, String univerdade, int anoNascimento, String cidadeNascimento, String estadoNascimento)
    {
        this.id = id;
        this.nome = nome;
        this.altura = altura;
    ...
    public static void inserirFim(Pilha jogador)
    {
        players.add(jogador);
    }
    
    public static Pilha removerFim()
    {
        Pilha retorno = players.get(players.size() - 1);
...
public static void main (String[] args) throws IOException
{
    ...
    while (aux < add) 
    {
        ...
        {
            Pilha show = removerFim();
            MyIO.println("(R) "+show.nome);
        }
        aux++;
    }
    int marcador = 0;
    for(Pilha player : players)
    {
